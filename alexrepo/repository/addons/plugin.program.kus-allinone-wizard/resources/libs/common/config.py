...
class Config:
    ...
    def init_uservars(self):
        ...
        self.ICONCLEAN = uservar.ICONCLEAN if not uservar.ICONCLEAN.endswith('://') else self.ADDON_ICON
        self.ICONADVANCED = uservar.ICONADVANCED if not uservar.ICONADVANCED.endswith('://') else self.ADDON_ICON
        self.ICONLOG = uservar.ICONLOG if not uservar.ICONLOG.endswith('://') else self.ADDON_ICON
        self.ICONADDON = uservar.ICONADDON if not uservar.ICONADDON.endswith('://') else self.ADDON_ICON
        self.ICONSYSTEM = uservar.ICONSYSTEM if not uservar.ICONSYSTEM.endswith('://') else self.ADDON_ICON
    ...
    def init_paths(self):
        # Static variables
        self.CLEANFREQ = ['Immer', 'jeden Tag', 'alle 3 Tage',
                          '1x Woche', '1x Monat']
