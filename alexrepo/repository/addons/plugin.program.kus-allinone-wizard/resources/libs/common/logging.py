...
def upload_log():
    ...
    for item in files:
        ...
        if succes:
            ...
            if succes:
                msg = "Poste diesen QR-Code >[CR]oder diese URL > [COLOR {2}]{3}[/COLOR][CR]zusammen mit einer Fehlerbeschreibung in unserer Facebook-Support-Gruppe[CR][COLORdeepskyblue]https://www.facebook.com/groups/kodiunlimited[/COLOR][CR]damit wir dir mit deinem Problem helfen können.".format(
