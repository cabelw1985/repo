...
def net_tools():
    directory.add_dir('Starte Speed Test', {'mode': 'speedtest'}, icon=CONFIG.ICONSPEED, themeit=CONFIG.THEME1)
    if CONFIG.HIDESPACERS == 'No':
        directory.add_separator()
    directory.add_dir('IP Addresse & MAC Addresse anzeigen', {'mode': 'viewIP'}, icon=CONFIG.ICONSPEED, themeit=CONFIG.THEME1)
...
def view_ip():
    ...
    directory.add_file('[COLOR {1}]MAC:[/COLOR] [COLOR {0}]{2}[/COLOR]'.format(CONFIG.COLOR1, CONFIG.COLOR2, mac), icon=CONFIG.ICONSPEED, themeit=CONFIG.THEME2)
    directory.add_file('[COLOR {1}]Interne IP: [COLOR {0}]{2}[/COLOR]'.format(CONFIG.COLOR1, CONFIG.COLOR2, inter_ip), icon=CONFIG.ICONSPEED, themeit=CONFIG.THEME2)
    directory.add_file('[COLOR {1}]Externe IP:[/COLOR] [COLOR {0}]{2}[/COLOR]'.format(CONFIG.COLOR1, CONFIG.COLOR2, ip), icon=CONFIG.ICONSPEED, themeit=CONFIG.THEME2)
    directory.add_file('[COLOR {1}]Stadt:[/COLOR] [COLOR {0}]{2}[/COLOR]'.format(CONFIG.COLOR1, CONFIG.COLOR2, city), icon=CONFIG.ICONSPEED, themeit=CONFIG.THEME2)
    directory.add_file('[COLOR {1}]Bundesland:[/COLOR] [COLOR {0}]{2}[/COLOR]'.format(CONFIG.COLOR1, CONFIG.COLOR2, state), icon=CONFIG.ICONSPEED, themeit=CONFIG.THEME2)
    directory.add_file('[COLOR {1}]Land:[/COLOR] [COLOR {0}]{2}[/COLOR]'.format(CONFIG.COLOR1, CONFIG.COLOR2, country), icon=CONFIG.ICONSPEED, themeit=CONFIG.THEME2)
    directory.add_file('[COLOR {1}]Anbieter:[/COLOR] [COLOR {0}]{2}[/COLOR]'.format(CONFIG.COLOR1, CONFIG.COLOR2, isp), icon=CONFIG.ICONSPEED, themeit=CONFIG.THEME2)
...
def save_menu():
    ...
    directory.add_dir('Behalte Trakt Daten', {'mode': 'trakt'}, icon=CONFIG.ICONTRAKT, themeit=CONFIG.THEME1)
    directory.add_dir('Behalte Debrid Daten', {'mode': 'realdebrid'}, icon=CONFIG.ICONDEBRID, themeit=CONFIG.THEME1)
    directory.add_dir('Behalte Login Informationen', {'mode': 'login'}, icon=CONFIG.ICONLOGIN, themeit=CONFIG.THEME1)
    directory.add_file('Importiere gespeicherte Daten', {'mode': 'managedata', 'name': 'import'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME1)
    directory.add_file('Exportiere gespeicherte Daten', {'mode': 'managedata', 'name': 'export'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME1)
    #directory.add_file('- Click to toggle settings -', themeit=CONFIG.THEME3)
    directory.add_file('Trakt Daten speichern: {0}'.format(trakt.replace('true', on).replace('false', off)), {'mode': 'togglesetting', 'name': 'keeptrakt'}, icon=CONFIG.ICONTRAKT, themeit=CONFIG.THEME1)
    directory.add_file('Debrid Daten speichern: {0}'.format(debrid.replace('true', on).replace('false', off)), {'mode': 'togglesetting', 'name': 'keepdebrid'}, icon=CONFIG.ICONDEBRID, themeit=CONFIG.THEME1)
    directory.add_file('Login Informationen speichern: {0}'.format(login.replace('true', on).replace('false', off)), {'mode': 'togglesetting', 'name': 'keeplogin'}, icon=CONFIG.ICONLOGIN, themeit=CONFIG.THEME1)
    directory.add_file('Quellen speichern: {0}'.format(sources.replace('true', on).replace('false', off)), {'mode': 'togglesetting', 'name': 'keepsources'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME1)
    directory.add_file('Profile speichern: {0}'.format(profiles.replace('true', on).replace('false', off)), {'mode': 'togglesetting', 'name': 'keepprofiles'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME1)
    directory.add_file('Playercorefactory speichern: {0}'.format(playercore.replace('true', on).replace('false', off)), {'mode': 'togglesetting', 'name': 'keepplayercore'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME1)
    directory.add_file('Guisettings speichern: {0}'.format(guisettings.replace('true', on).replace('false', off)), {'mode': 'togglesetting', 'name': 'keepguiseettings'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME1)
    directory.add_file('Advancedsettings speichern: {0}'.format(advanced.replace('true', on).replace('false', off)), {'mode': 'togglesetting', 'name': 'keepadvanced'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME1)
    directory.add_file('Favoriten speichern: {0}'.format(favourites.replace('true', on).replace('false', off)), {'mode': 'togglesetting', 'name': 'keepfavourites'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME1)
    directory.add_file('SuperFavoriten speichern: {0}'.format(super.replace('true', on).replace('false', off)), {'mode': 'togglesetting', 'name': 'keepsuper'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME1)
    directory.add_file('Installierte Repo\'s speichern: {0}'.format(repos.replace('true', on).replace('false', off)), {'mode': 'togglesetting', 'name': 'keeprepos'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME1)
    directory.add_file('WhiteList speichern: {0}'.format(whitelist.replace('true', on).replace('false', off)), {'mode': 'togglesetting', 'name': 'keepwhitelist'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME1)
    if whitelist == 'true':
        directory.add_file('> Whitelist bearbeiten', {'mode': 'whitelist', 'name': 'edit'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME1)
        directory.add_file('> Whitelist anzeigen', {'mode': 'whitelist', 'name': 'view'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME1)
        directory.add_file('> Whitelist bereinigen', {'mode': 'whitelist', 'name': 'clear'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME1)
        directory.add_file('> Whitelist importieren', {'mode': 'whitelist', 'name': 'import'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME1)
        directory.add_file('> Whitelist exportieren', {'mode': 'whitelist', 'name': 'export'}, icon=CONFIG.ICONSAVE, themeit=CONFIG.THEME1)


def trakt_menu():
    from resources.libs import traktit

    keep_trakt = '[COLORlime]AN[/COLOR]' if CONFIG.KEEPTRAKT == 'true' else '[COLORred]AUS[/COLOR]'
    last = str(CONFIG.TRAKTSAVE) if not CONFIG.TRAKTSAVE == '' else 'Trakt hasn\'t been saved yet.'
    directory.add_file('Registriere ein Konto unter https://www.trakt.tv', icon=CONFIG.ICONTRAKT, themeit=CONFIG.THEME3)
    directory.add_file('> Trakt Daten speichern: {0}'.format(keep_trakt), {'mode': 'togglesetting', 'name': 'keeptrakt'}, icon=CONFIG.ICONTRAKT, themeit=CONFIG.THEME1)
    if CONFIG.KEEPTRAKT == 'true':
        directory.add_file('[COLORwhite]Letzte Sicherung:[/COLOR] {0}'.format(str(last)), icon=CONFIG.ICONTRAKT, themeit=CONFIG.THEME3)
    ...
    for trakt in traktit.ORDER:
        if xbmc.getCondVisibility('System.HasAddon({0})'.format(traktit.TRAKTID[trakt]['plugin'])):
            ...
            directory.add_file('[+]-> [COLORwhite]{0}[/COLOR]'.format(name), icon=icon, fanart=fanart, themeit=CONFIG.THEME3)
            if not os.path.exists(path):
                directory.add_file('[COLORred]Addon Daten: nicht installiert[/COLOR]', icon=icon, fanart=fanart, menu=menu)
            elif not auser:
                directory.add_file('[COLORred]Addon Daten: nicht registriert[/COLOR]', {'mode': 'authtrakt', 'name': trakt}, icon=icon, fanart=fanart, menu=menu)
            else:
                directory.add_file('[COLORlime]Addon Daten: {0}[/COLOR]'.format(auser), {'mode': 'authtrakt', 'name': trakt}, icon=icon, fanart=fanart, menu=menu)
            if user == "":
                if os.path.exists(file):
                    directory.add_file('[COLORred]Gespeicherte Daten: gespeicherte Daten gefunden (Daten importieren)[/COLOR]', {'mode': 'importtrakt', 'name': trakt}, icon=icon, fanart=fanart, menu=menu2)
                else:
                    directory.add_file('[COLORred]gespeicherte Daten: nicht gespeichert[/COLOR]', {'mode': 'savetrakt', 'name': trakt}, icon=icon, fanart=fanart, menu=menu2)
            else:
                directory.add_file('[COLORlime]Gespeicherte Daten: {0}[/COLOR]'.format(user), icon=icon, fanart=fanart, menu=menu2)

    directory.add_separator()
    directory.add_file('> alle Trakt Daten speichern', {'mode': 'savetrakt', 'name': 'all'}, icon=CONFIG.ICONTRAKT, themeit=CONFIG.THEME1)
    directory.add_file('> alle gespeicherten Trakt Daten wiederherstellen', {'mode': 'restoretrakt', 'name': 'all'}, icon=CONFIG.ICONTRAKT, themeit=CONFIG.THEME1)
    directory.add_file('> Trakt Daten importieren', {'mode': 'importtrakt', 'name': 'all'}, icon=CONFIG.ICONTRAKT, themeit=CONFIG.THEME1)
    directory.add_file('> alle Addon Trakt Daten bereinigen', {'mode': 'addontrakt', 'name': 'all'}, icon=CONFIG.ICONTRAKT, themeit=CONFIG.THEME1)
    directory.add_file('> alle gespeicherten Trakt Daten bereinigen', {'mode': 'cleartrakt', 'name': 'all'}, icon=CONFIG.ICONTRAKT, themeit=CONFIG.THEME1)


def debrid_menu():
    from resources.libs import debridit

    keep_debrid = '[COLORlime]AN[/COLOR]' if CONFIG.KEEPDEBRID == 'true' else '[COLORred]AUS[/COLOR]'
    last = str(CONFIG.DEBRIDSAVE) if not CONFIG.DEBRIDSAVE == '' else 'Debrid authorizations haven\'t been saved yet.'
    directory.add_file('https://www.real-debrid.com ist ein Bezahldienst !', icon=CONFIG.ICONDEBRID, themeit=CONFIG.THEME3)
    directory.add_file('https://www.premiumize.me ist ein Bezahldienst !', icon=CONFIG.ICONDEBRID, themeit=CONFIG.THEME3)
    directory.add_file('> Debrid Daten speichern: {0}'.format(keep_debrid), {'mode': 'togglesetting', 'name': 'keepdebrid'}, icon=CONFIG.ICONDEBRID, themeit=CONFIG.THEME1)
    if CONFIG.KEEPDEBRID == 'true':
        directory.add_file('[COLORwhite]Letzte Sicherung:[/COLOR] {0}'.format(str(last)), icon=CONFIG.ICONDEBRID, themeit=CONFIG.THEME3)
    ...
    for debrid in debridit.ORDER:
        if xbmc.getCondVisibility('System.HasAddon({0})'.format(debridit.DEBRIDID[debrid]['plugin'])):
            ...
            directory.add_file('[+]-> [COLORwhite]{0}[/COLOR]'.format(name), icon=icon, fanart=fanart, themeit=CONFIG.THEME3)
            if not os.path.exists(path):
                directory.add_file('[COLORred]Addon Datem: nicht installiert[/COLOR]', icon=icon, fanart=fanart, menu=menu)
            elif not auser:
                directory.add_file('[COLORred]Addon Daten: nicht registriert[/COLOR]', {'mode': 'authdebrid', 'name': debrid}, icon=icon, fanart=fanart, menu=menu)
            else:
                directory.add_file('[COLORlime]Addon Daten: {0}[/COLOR]'.format(auser), {'mode': 'authdebrid', 'name': debrid}, icon=icon, fanart=fanart, menu=menu)
            if user == "":
                if os.path.exists(file):
                    directory.add_file('[COLORred]Gespeicherte Daten: gespeicherte Daten gefunden (Daten importieren)[/COLOR]', {'mode': 'importdebrid', 'name': debrid}, icon=icon, fanart=fanart, menu=menu2)
                else:
                    directory.add_file('[COLORred]Gespeicherte Daten: nicht gespeichert[/COLOR]', {'mode': 'savedebrid', 'name': debrid}, icon=icon, fanart=fanart, menu=menu2)
            else:
                directory.add_file('[COLORlime]Gespeicherte Daten: {0}[/COLOR]'.format(user), icon=icon, fanart=fanart, menu=menu2)

    directory.add_separator(themeit=CONFIG.THEME3)
    directory.add_file('> alle Debrid Daten speichern', {'mode': 'savedebrid', 'name': 'all'}, icon=CONFIG.ICONDEBRID, themeit=CONFIG.THEME1)
    directory.add_file('> alle gespeicherten Debrid Daten wiederherstellen', {'mode': 'restoredebrid', 'name': 'all'}, icon=CONFIG.ICONDEBRID, themeit=CONFIG.THEME1)
    directory.add_file('> Debrid Daten importieren', {'mode': 'importdebrid', 'name': 'all'}, icon=CONFIG.ICONDEBRID, themeit=CONFIG.THEME1)
    directory.add_file('> alle Addon Debrid Daten bereinigen', {'mode': 'addondebrid', 'name': 'all'}, icon=CONFIG.ICONDEBRID, themeit=CONFIG.THEME1)
    directory.add_file('> alle gespeicherten Debrid Daten bereinigen', {'mode': 'cleardebrid', 'name': 'all'}, icon=CONFIG.ICONDEBRID, themeit=CONFIG.THEME1)
...
def login_menu():
    ...
    directory.add_file('Einige dieser Addons sind Bezahldienste !', icon=CONFIG.ICONLOGIN, themeit=CONFIG.THEME3)
    directory.add_file('> API Keys speichern: {0}'.format(keep_login), {'mode': 'togglesetting', 'name': 'keeplogin'}, icon=CONFIG.ICONLOGIN, themeit=CONFIG.THEME1)
    if CONFIG.KEEPLOGIN == 'true':
        directory.add_file('[COLORwhite]Letzte Sicherung:[/COLOR] {0}'.format(str(last)), icon=CONFIG.ICONLOGIN, themeit=CONFIG.THEME3)
    ...
    for login in loginit.ORDER:
        if xbmc.getCondVisibility('System.HasAddon({0})'.format(loginit.LOGINID[login]['plugin'])):
            ...
            if not os.path.exists(path):
                ...
                directory.add_file('[COLORred]Addon Daten: nicht registriert[/COLOR]', {'mode': 'authlogin', 'name': login}, icon=icon, fanart=fanart, menu=menu)
            else:
                directory.add_file('[COLORlime]Addon Daten: {0}[/COLOR]'.format(auser), {'mode': 'authlogin', 'name': login}, icon=icon, fanart=fanart, menu=menu)
            if user == "":
                if os.path.exists(file):
                    directory.add_file('[COLORred]Gespeicherte Daten: gespeicherte Daten gefunden (Daten importieren)[/COLOR]', {'mode': 'importlogin', 'name': login}, icon=icon, fanart=fanart, menu=menu2)
                else:
                    directory.add_file('[COLORred]Gespeicherte Daten: nicht gespeichert[/COLOR]', {'mode': 'savelogin', 'name': login}, icon=icon, fanart=fanart, menu=menu2)
            else:
                directory.add_file('[COLORlime]Gespeicherte Daten: {0}[/COLOR]'.format(user), icon=icon, fanart=fanart, menu=menu2)

    directory.add_separator(themeit=CONFIG.THEME3)
    directory.add_file('> alle Login Informationen speichern', {'mode': 'savelogin', 'name': 'all'}, icon=CONFIG.ICONLOGIN, themeit=CONFIG.THEME1)
    directory.add_file('> alle gespeicherten Login Informationen wiederherstellen', {'mode': 'restorelogin', 'name': 'all'}, icon=CONFIG.ICONLOGIN, themeit=CONFIG.THEME1)
    directory.add_file('> Login Informationen wiederherstellen', {'mode': 'importlogin', 'name': 'all'}, icon=CONFIG.ICONLOGIN, themeit=CONFIG.THEME1)
    directory.add_file('> alle Addon Login Informationen bereinigen', {'mode': 'addonlogin', 'name': 'all'}, icon=CONFIG.ICONLOGIN, themeit=CONFIG.THEME1)
    directory.add_file('> alle gespeicherten Login Informationen bereinigen', {'mode': 'clearlogin', 'name': 'all'}, icon=CONFIG.ICONLOGIN, themeit=CONFIG.THEME1)
...
def enable_addons(all=False):
    ...
    if not all:
        if len(addonids) == 0:
            directory.add_file("Keine Addons zum Aktivieren oder Deaktivieren gefunden.", icon=CONFIG.ICONADDON)
        else:
            directory.add_file("[COLORred]Hinweis: Das Deaktivieren einiger Addons kann zu Problemen führen ![/COLOR]", icon=CONFIG.ICONADDON)
            directory.add_dir('> aktiviere alle Addons', {'mode': 'enableall'}, icon=CONFIG.ICONADDON, themeit=CONFIG.THEME1)
            for i in range(0, len(addonids)):
                ...
                if tools.get_addon_info(addonids[i], 'name'):
                    state = "[COLORlime][Aktiviert][/COLOR]"
                    goto = "false"
                else:
                    state = "[COLORred][Deaktiviert][/COLOR]"
                    goto = "true"
...
def remove_addon_data_menu():
    if os.path.exists(CONFIG.ADDON_DATA):
        directory.add_file('[COLORred][LÖSCHE][/COLOR] alle Addon Daten', {'mode': 'removedata', 'name': 'all'}, themeit=CONFIG.THEME1)
        directory.add_file('[COLORred][LÖSCHE][/COLOR] alle Addon Daten von deinstallierten Addons', {'mode': 'removedata', 'name': 'uninstalled'}, themeit=CONFIG.THEME1)
        directory.add_file('[COLORred][LÖSCHE][/COLOR] alle leeren Ordner in den Addon Daten', {'mode': 'removedata', 'name': 'empty'}, themeit=CONFIG.THEME1)
        directory.add_file('[COLORred][LÖSCHE][/COLOR] {0} Addon Daten'.format(CONFIG.ADDONTITLE), {'mode': 'resetaddon'}, themeit=CONFIG.THEME1)
        directory.add_separator(themeit=CONFIG.THEME3)
        ...
        for folder in sorted(fold, key = lambda x: x):
            ...
            replace = {'audio.': '[COLORwhite][AUDIO] [/COLOR]', 'metadata.': '[COLORwhite][METADATA] [/COLOR]',
                       'module.': '[COLORwhite][MODULE] [/COLOR]', 'plugin.': '[COLORwhite][PLUGIN] [/COLOR]',
                       'program.': '[COLORwhite][PROGRAM] [/COLOR]', 'repository.': '[COLORwhite][REPO] [/COLOR]',
                       'script.': '[COLORwhite][SCRIPT] [/COLOR]',
                       'service.': '[COLORwhite][SERVICE] [/COLOR]', 'skin.': '[COLORwhite][SKIN] [/COLOR]',
                       'video.': '[COLORwhite][VIDEO] [/COLOR]', 'weather.': '[COLORwhite][WEATHER] [/COLOR]'}
            for rep in replace:
                folderdisplay = folderdisplay.replace(rep, replace[rep])
            if foldername in CONFIG.EXCLUDES:
                folderdisplay = '[COLORwhite]>[/COLOR] [COLORlime][GESPERRT][/COLOR] {0}'.format(folderdisplay)
            else:
                folderdisplay = '[COLORwhite]>[/COLOR] [COLORred][LÖSCHE][/COLOR] {0}'.format(folderdisplay)
            directory.add_file(' {0}'.format(folderdisplay), {'mode': 'removedata', 'name': foldername}, icon=icon, fanart=fanart, themeit=CONFIG.THEME2)
    else:
        directory.add_file('Kein Addon-Datenordner gefunden.', themeit=CONFIG.THEME3)
...
def change_freq():
    ...
    change = dialog.select("[COLOR {0}]Wähle den Intervall für die Reinigung...[/COLOR]".format(CONFIG.COLOR2), CONFIG.CLEANFREQ)
    if not change == -1:
...
def create_addon_data_menu(add='', name=''):
    ...
    menu_items.append((CONFIG.THEME3.format('{0} Daten speichern'.format(add3)), 'RunPlugin(plugin://{0}/?mode=save{1}&name={2})'.format(CONFIG.ADDON_ID, add2, name2)))
    menu_items.append((CONFIG.THEME3.format('{0} Daten wiederherstellen'.format(add3)), 'RunPlugin(plugin://{0}/?mode=restore{1}&name={2})'.format(CONFIG.ADDON_ID, add2, name2)))
    menu_items.append((CONFIG.THEME3.format('{0} Daten bereinigen'.format(add3)), 'RunPlugin(plugin://{0}/?mode=clear{1}&name={2})'.format(CONFIG.ADDON_ID, add2, name2)))

    menu_items.append((CONFIG.THEME2.format('{0} Einstellungen'.format(CONFIG.ADDONTITLE)), 'RunPlugin(plugin://{0}/?mode=settings)'.format(CONFIG.ADDON_ID)))
...
def create_save_data_menu(add='', name=''):
    ...
    name = name.replace('url', 'URL Resolver')
    menu_items.append((CONFIG.THEME2.format(name.title()), ' '))
    menu_items.append((CONFIG.THEME3.format('Registriere {0}'.format(add3)), 'RunPlugin(plugin://{0}/?mode=auth{1}&name={2})'.format(CONFIG.ADDON_ID, add2, name2)))
    menu_items.append((CONFIG.THEME3.format('{0} Daten speichern'.format(add3)), 'RunPlugin(plugin://{0}/?mode=save{1}&name={2})'.format(CONFIG.ADDON_ID, add2, name2)))
    menu_items.append((CONFIG.THEME3.format('{0} Daten wiederherstellen'.format(add3)), 'RunPlugin(plugin://{0}/?mode=restore{1}&name={2})'.format(CONFIG.ADDON_ID, add2, name2)))
    menu_items.append((CONFIG.THEME3.format('{0} Daten importieren'.format(add3)), 'RunPlugin(plugin://{0}/?mode=import{1}&name={2})'.format(CONFIG.ADDON_ID, add2, name2)))
    menu_items.append((CONFIG.THEME3.format('{0} Addon Daten bereinigen'.format(add3)), 'RunPlugin(plugin://{0}/?mode=addon{1}&name={2})'.format(CONFIG.ADDON_ID, add2, name2)))
